...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDCa20aC5F21dC661c65606d255415FC4d194A910;
...
contract Olivercoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfbdE9e8bAFc6756D10b4E5DFba67bfA8c821F3ed;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Oliver Coin";
    string private _symbol = "OLC";
    ...
    uint256 public _maxTxAmount = 1200000000 * 10**18;
